...
class HistoryScreenView extends GetView<ActivityScreenController> {
      ...
      builder: (context, constraints) {
        return Scaffold(
          ...
          appBar: AppBar(
            ...
            title: const Text('Account History', style: TextStyle(fontSize: 18, color: Colors.black, fontFamily: 'Urbanist-semibold', fontWeight: FontWeight.w600),),
            centerTitle: true,
            actions: [
              SizedBox(
                  height: 24,
                    ...
                    return Padding(
                      ...
                      child: InkWell(
                        ...
                        child: ListTile(
                          ...
                          subtitle: Text(sutext[index], style: const TextStyle(fontSize: 12, color: Color(0xff64748B), fontWeight: FontWeight.w500, fontFamily: 'Urbanist-medium'),),
